<%@ Page Title="FNSIGN > Locations" Language="C#" MasterPageFile="~/fnsign.master" AutoEventWireup="true" CodeBehind="locations.aspx.cs" Inherits="fnsignManager.locations" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content_main" runat="server">
    <section role="main" class="content-body">
        ...
        <a href="/locations/add" class="mb-xs mt-xs mr-xs btn btn-success"><i class="fa fa-user"></i> Add Location</a>
		...
		<header class="page-header">
			...
			<div class="right-wrapper pull-right">
				<ol class="breadcrumbs">
					...
					<li><i class="fa fa-gears"></i> <span>Locations</span></li>
				</ol>
				...
				<div class="panel-body">
					<table class="table table-no-more table-bordered table-striped mb-none">
						<thead>
							<tr>
								<th>Title</th>
								<th class="text-right">Sched ID</th>
							</tr>
						</thead>
						<tbody>
