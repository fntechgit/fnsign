...
namespace fnsignManager
{
    public partial class add_message : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Page.RouteData.Values["id"] != null)
                {
                    ...
                    ck_priority.Checked = m.priority;
                    ck_full.Checked = m.session_full;
                    ck_test.Checked = m.test;
        ...
        protected void update(object sender, EventArgs e)
        {
            ...
            m.priority = ck_priority.Checked;
            m.title = title.Text;
            m.message = message.Text;
            m.test = ck_test.Checked;
            ...
            m.session_full = ck_full.Checked;
