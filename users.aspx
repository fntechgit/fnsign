<%@ Page Title="FNSIGN > Manage Users" Language="C#" MasterPageFile="~/fnsign.master" AutoEventWireup="true" CodeBehind="users.aspx.cs" Inherits="fnsignManager.users" %>
     ...
     <section role="main" class="content-body">
		<header class="page-header">
			...
			<div class="right-wrapper pull-right">
				<ol class="breadcrumbs">
					...
					<li><i class="fa fa-users"></i> <span>Manage User Accounts</span></li>
				</ol>
		...
		<!-- start: page -->
			<section class="panel">
                ...
                <a href="/users/add" class="mb-xs mt-xs mr-xs btn btn-success"><i class="fa fa-user"></i> Add User</a>
				...
				<header class="panel-heading">
					...
					<h2 class="panel-title">System User Accounts</h2>
				</header>
					...
					<table class="table table-no-more table-bordered table-striped mb-none">
						<thead>
							<tr>
                                ...
                                <th class="hidden-xs hidden-sm">Notify</th>
                                <th>Actions</th>
							</tr>
						</thead>
						<tbody>
