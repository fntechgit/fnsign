								...
								<section class="panel">
									...
									<div class="panel-body">
										<div class="form-horizontal form-bordered">
                                            ...
                                            <h4>End of Day Messaging</h4>

                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="eod_title">Title</label>
                                                <div class="col-md-6">
                                                    <asp:TextBox runat="server" ID="eod_title" CssClass="form-control" placeholder="End of Day" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <asp:TextBox runat="server" ID="eod_category" CssClass="form-control" placeholder="Data @Scale"/>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Time (what should display in the session time field)</label>
                                                <div class="col-md-6">
                                                    <asp:TextBox runat="server" ID="eod_time" CssClass="form-control" placeholder="Time"/>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description (what displays in the description field if used by template)</label>
                                                <div class="col-md-6">
                                                    <asp:TextBox runat="server" ID="eod_description" CssClass="form-control" TextMode="MultiLine" style="height:150px;" ClientIDMode="Static" />
                                                </div>
                                            </div>
                                            
                                            <h4>No Session Messaging</h4>

                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="ns_title">Title</label>
                                                <div class="col-md-6">
                                                    <asp:TextBox runat="server" ID="ns_title" CssClass="form-control" placeholder="End of Day" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Category</label>
                                                <div class="col-md-6">
                                                    <asp:TextBox runat="server" ID="ns_category" CssClass="form-control" placeholder="Data @Scale"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Time (what should display in the session time field)</label>
                                                <div class="col-md-6">
                                                    <asp:TextBox runat="server" ID="ns_time" CssClass="form-control" placeholder="Time"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Description (what displays in the description field if used by template)</label>
                                                <div class="col-md-6">
                                                    <asp:TextBox runat="server" ID="ns_description" CssClass="form-control" TextMode="MultiLine" style="height:150px;" ClientIDMode="Static" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="ns_title">Timezone</label>
                                                <div class="col-md-6">
                                                    <asp:DropDownList ID="ddl_timezone" runat="server">
                                                      ...
                                                      <asp:ListItem value="-8">(GMT-08:00) Pacific Time (USA or Canada); Tijuana</asp:ListItem>
                                                      <asp:ListItem value="-7">(GMT-07:00) Mountain Time (USA or Canada)</asp:ListItem>
                                                      <asp:ListItem value="-6">(GMT-06:00) Central time (USA or Canada)</asp:ListItem>
                                                      <asp:ListItem value="-5">(GMT-05:00) Eastern time (USA or Canada)</asp:ListItem>
                                            ...
                                            <div class="form-group">
												<label class="col-md-3 control-label">Set Current Date (Timewarp)</label>
												<div class="col-md-6">
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fa fa-calendar"></i>
														</span>
													    <asp:TextBox runat="server" ID="timewarp_date" ClientIDMode="Static" data-plugin-datepicker CssClass="form-control" />
													</div>
												</div>
											</div>
                                            
                                            <div class="form-group">
												<label class="col-md-3 control-label">Set Current Time</label>
												<div class="col-md-6">
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fa fa-clock-o"></i>
														</span>
													    <asp:TextBox runat="server" ID="timewarp_time" ClientIDMode="Static" data-plugin-timepicker CssClass="form-control" />
													</div>
												</div>
											</div>
                                            
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Move Time (if checked the value set in "Time Warp Current Time" will move forward like real world time)</label>
                                                <div class="col-md-6">
                                                    <asp:CheckBox runat="server" ID="ck_runtime" />
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Override Display System time with Timewarp Time</label>
                                                <div class="col-md-6">
                                                    <asp:CheckBox runat="server" ID="ck_display" />
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Override FNSIGN System time with Timewarp Time</label>
                                                <div class="col-md-6">
                                                    <asp:CheckBox runat="server" ID="ck_fnsign" />
                                                </div>
                                            </div>
                                            
                                            <h4>Full Session Graphic</h4>
                                            ...
                                            <asp:Panel runat="server" ID="pnl_current_image" Visible="false">
												...
												<div class="col-md-9">
													<asp:Image runat="server" ID="current_image" style="width: 50%;"/>
												</div>
											</div>
                                            </asp:Panel>
