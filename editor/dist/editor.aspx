<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editor.aspx.cs" Inherits="fnsignManager.editor.dist.editor" ValidateRequest="false" %>
...
<head runat="server">
    <meta charset="utf-8">
    <title>FNSIGN Overlay Builder</title>
    ...
    <div id="builder">
        ...
        <div class="menu" id="menu">
            ...
            <div class="main" id="main">
                ...
                <h3>
                    <span class="fui-windows"></span> Overlays
                </h3>
                
                <input type="hidden" id="current_overlay_id" value="0"/>
                ...
                <ul id="pages">
                    ...
                    <li style="display: none;" id="newPageLI">
                        ...
                        <span class="pageButtons">
                            <a href="" class="fileEdit"><span class="fui-new"></span></a>q
                    ...
                    <asp:PlaceHolder runat="server" ID="ph_current_overlays"></asp:PlaceHolder>
                    
                </ul>

                <div class="sideButtons clearfix">
                    <a href="#" class="btn btn-primary btn-sm btn-embossed" id="addPage">
                        <span class="fui-plus"></span> Add Overlay
                    </a>
                </div>
        ...
        <div class="container">
            ...
            <header class="clearfix affix">
                ...
                <a href="#" id="clearScreen" class="btn btn-inverse pull-right actionButtons nohover">
                    <i class="fui-trash"></i> 
                    <span>Empty Overlay</span>
                </a>

                <a href="/" data-toggle="modal" class="btn btn-inverse pull-right actionButtons">
                    <i class="fui-window"></i>
                    <span>Return to FNSIGN</span>
                </a>
            ...
            <div class="screen" id="screen">
                ...
                <div id="frameWrapper" class="frameWrapper empty">
                    ...
                    <div class="start" id="start">
                        <span>BUILD YOUR OVERLAY BY DRAGGING BLOCKS ONTO THE CANVAS</span>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>
                           Please note this is only a preview of the OVERLAY, you will need to connect a Template to the Overlay to integrate the background image (usually provided by the client).
                    </p>
