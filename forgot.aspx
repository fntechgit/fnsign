<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgot.aspx.cs" Inherits="fnsignManager.forgot" %>
					...
					<div class="panel-body">
                            ...
                            <asp:Panel runat="server" ID="pnl_success" Visible="false">
                                <div class="alert alert-success">
                                    ...
                                    <strong>Password Sent</strong> your password has been sent, you may use it to <a href="/login">Login</a>
                                </div>
                            </asp:Panel>
                        ...
                        <asp:Panel runat="server" ID="pnl_failure" Visible="false">
                                <div class="alert alert-danger">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                    <strong>No Account Found</strong> You do not have an account in FNSIGN with that email.  
                                </div>
                            </asp:Panel>
							...
							<div class="row">
								<div class="col-sm-12 text-right">
								    <asp:Button runat="server" ID="btn_login_small" Text="Submit" CssClass="btn btn-primary hidden-xs" OnClick="signin" />
									<asp:Button runat="server" ID="btn_login_large" Text="Submit" CssClass="btn btn-primary btn-block btn-lg visible-xs mt-lg" OnClick="signin" />
								</div>
							</div>
					</div>
				</div>
