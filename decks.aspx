<%@ Page Title="FNSIGN > Slide Decks" Language="C#" MasterPageFile="~/fnsign.master" AutoEventWireup="true" CodeBehind="decks.aspx.cs" Inherits="fnsignManager.decks" %>
    ...
    <section role="main" class="content-body">
		...
		<!-- start: page -->
			<section class="panel">
                ...
                <a href="/decks/add" class="mb-xs mt-xs mr-xs btn btn-success"><i class="fa fa-plus-circle"></i> Add New Deck</a>
