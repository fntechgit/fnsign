...
<asp:Content ID="Content3" ContentPlaceHolderID="content_main" runat="server">
    <section role="main" class="content-body">
        ...
        <a href="/sessions/add" class="mb-xs mt-xs mr-xs btn btn-success"><i class="fa fa-user"></i> Add Session</a>
        <a href="/sessions/import" class="mb-xs mt-xs mr-xs btn btn-warning"><i class="fa fa-upload"></i> Import</a>
