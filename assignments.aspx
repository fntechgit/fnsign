<%@ Page Title="FNSIGN > Assignments" Language="C#" MasterPageFile="~/fnsign.master" AutoEventWireup="true" CodeBehind="assignments.aspx.cs" Inherits="fnsignManager.assignments" %>
		...
		<header class="page-header">
			...
			<div class="right-wrapper pull-right">
				<ol class="breadcrumbs">
					...
					<li><i class="fa fa-gears"></i> <span>Assignments</span></li>
				</ol>
					...
					<table class="table table-no-more table-bordered table-striped mb-none">
						<thead>
							<tr>
                                ...
                                <th class="hidden-xs hidden-sm">Template</th>
                                <th>Actions</th>
							</tr>
						</thead>
						<tbody>
