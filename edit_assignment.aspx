								...
								<section class="panel">
									...
									<div class="panel-body">
										<div class="form-horizontal form-bordered">
                                            ...
                                            <div class="form-group" id="all_sessions" runat="server">
                                                <label class="col-md-3 control-label">All Sessions</label>
                                                <div class="col-md-6">
                                                    <asp:CheckBox runat="server" ID="ck_all_sessions"/>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group" id="gruop_by_location" runat="server">
                                                <label class="col-md-3 control-label">Group by Location (can't be used at same time as group by start time)</label>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group" id="Div2" runat="server">
                                                <label class="col-md-3 control-label">Group by Start Time (can't be used at the same time as group by location)</label>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group" id="template_announcement" runat="server">
												<label class="col-md-3 control-label">Priority Announcement Template</label>
												<div class="col-md-6">
												    <asp:DropDownList runat="server" ID="ddl_template_announce">
                                                    </asp:DropDownList>
												</div>
											</div>
                                            
                                            <div class="form-group" id="template_end" runat="server">
												<label class="col-md-3 control-label">End of Day Template</label>
												<div class="col-md-6">
												    <asp:DropDownList runat="server" ID="ddl_template_end">
                                                    </asp:DropDownList>
												</div>
											</div>
