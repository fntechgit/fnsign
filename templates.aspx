<%@ Page Title="FNSIGN > Templates" Language="C#" MasterPageFile="~/fnsign.master" AutoEventWireup="true" CodeBehind="templates.aspx.cs" Inherits="fnsignManager.templates" %>
		...
		<header class="page-header">
			...
			<div class="right-wrapper pull-right">
				<ol class="breadcrumbs">
					...
					<li><i class="fa fa-gears"></i> <span>Templates</span></li>
				</ol>
					...
					<table class="table table-no-more table-bordered table-striped mb-none">
						<thead>
							<tr>
								...
								<th class="hidden-xs hidden-sm">Font</th>
                                <th class="hidden-xs hidden-sm">Font Color</th>
                                <th class="text-right">Overlay</th>
                                <th>Actions</th>
							</tr>
						</thead>
						<tbody>
