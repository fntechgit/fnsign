<%@ Page Title="Event Monitors" Language="C#" MasterPageFile="~/fnsign.master" AutoEventWireup="true" CodeBehind="event_monitors.aspx.cs" Inherits="fnsignManager.event_monitors" %>
     ...
     <section role="main" class="content-body">
		<header class="page-header">
			...
			<div class="right-wrapper pull-right">
				<ol class="breadcrumbs">
                    ...
                    <li><a href="/events"><i class="fa fa-calendar"</a></li>
					<li><i class="fa fa-users"></i> <span>Display Monitors</span></li>
				</ol>
		...
		<!-- start: page -->
			<section class="panel">
                ...
                <asp:Button runat="server" ID="btn_ad_monitor" CssClass="mb-xs mt-xs mr-xs btn btn-primary" Text="Add Monitor" OnClick="add_monitor" />
				...
				<header class="panel-heading">
					...
					<h2 class="panel-title"><%= ev.title %>: Display Monitors</h2>
				</header>
