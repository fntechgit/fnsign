<%@ Page Title="Add / Edit Location" Language="C#" MasterPageFile="~/fnsign.master" AutoEventWireup="true" CodeBehind="add_location.aspx.cs" Inherits="fnsignManager.add_location" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content_main" runat="server">
    <section role="main" class="content-body">
					<header class="page-header">
						<h2><%= add_edit.ToUpper() %> A LOCATION</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
                                ...
                                <li>
                                    <a href="/locations"><i class="fa fa-bullhorn"></i> Locations</a>
                                </li>
								<li><i class="fa fa-plus"></i> <span><%= add_edit %> a Location</span></li>
							</ol>
                    ...
                    <asp:Panel runat="server" ID="pnl_success" Visible="false">
                        <div class="alert alert-success">
                            ...
                            <strong>Success!</strong> You have successfully performed an <%= add_edit %> operation for this location!
                        </div>
                    </asp:Panel>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title"><%= add_edit %> a Location</h2>
									</header>
										...
										<div class="form-horizontal form-bordered">
											<div class="form-group">
												...
												<div class="col-md-6">
                                                    ...
                                                    <asp:HiddenField runat="server" ID="hdn_sched_id" Value=""/>
												</div>
											</div>                                  
