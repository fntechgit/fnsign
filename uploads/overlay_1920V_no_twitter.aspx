...
<head runat="server">
    <title></title>
		...
		<style type="text/css">
			...
			.session-title {font-family: "Gotham Narrow Book", Gotham; font-size: 48px;font-weight:bold;margin-bottom: 40px;margin-top:13px;color: #82262f; }
			.start-time { margin-top: 215px;font-family: "Gotham Narrow Book", Gotham;color: #000000;font-size: 80px;float: left;width: 387px; }
			.current-time { float: left;margin-top: 215px;color: #82262f;font-size: 48px;font-family: "Gotham Narrow Book", Gotham; }
			.next-header { margin-top: 100px;color: #82262f;font-family: "Gotham Narrow Book", Gotham;font-size: 35px; }
			.next-session { margin-top: 15px;color: #000000;font-family: "Gotham Narrow Book", Gotham;font-size: 48px; }
			.left { float:left; }
			.right { float:right; }
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="next-session" id="next_session"></div>
    </div>
