<%@ Page Title="Template Builder > Clone Overlay" Language="C#" MasterPageFile="~/fnsign.master" AutoEventWireup="true" CodeBehind="clone_overlay.aspx.cs" Inherits="fnsignManager.clone_overlay" %>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Clone an Overlay</h2>
									</header>
									<div class="panel-body">
										<div class="form-horizontal form-bordered">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="ddl_clone">Overlay to Clone</label>
                                                <div class="col-md-9">
                                                    <asp:DropDownList runat="server" ID="ddl_clone" ClientIDMode="Static">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label class="col-md-3 control-label" for="fup_guide">Guide Background (if not uploaded the original from the clone will be used)</label>
                                                <div class="col-md-6">
