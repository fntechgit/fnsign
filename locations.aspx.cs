...
namespace fnsignManager
{
    public partial class locations : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ph_tags.Controls.Add(new LiteralControl("<tr><td data-title=\"Title\">" + t.title.ToUpper() + "</td><td data-title=\"Sched ID\" class=\"text-right\">" + t.sched_id + "</td><td data-title=\"Actions\"><a href=\"/locations/edit/" + t.id + "\"><i class=\"fa fa-edit\"></i></a> <a href=\"/locations/delete/" + t.id + "\"><i class=\"fa fa-trash-o\"></i></a> <a href=\"/sublocations/" + t.id + "\"><i class=\"fa fa-plus-circle\"></i></a></td></tr>"));
            }
        }
