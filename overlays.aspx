<%@ Page Title="Overlays" Language="C#" MasterPageFile="~/fnsign.master" AutoEventWireup="true" CodeBehind="overlays.aspx.cs" Inherits="fnsignManager.overlays" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content_main" runat="server">
    <section role="main" class="content-body">
        ...
        <a href="/overlays/builder/step-1" class="mb-xs mt-xs mr-xs btn btn-success"><i class="fa fa-user"></i> Add Overlay</a>
        <a href="/overlays/clone" class="mb-xs mt-xs mr-xs btn btn-success"><i class="fa fa-clone"></i> Clone Overlay</a>
		...
		<header class="page-header">
			...
			<div class="right-wrapper pull-right">
				<ol class="breadcrumbs">
					...
					<li><i class="fa fa-gears"></i> <span>Overlays</span></li>
				</ol>
		...
		<!-- start: page -->
			<section class="panel">
				...
				<header class="panel-heading">
					...
					<h2 class="panel-title">Overlays</h2>
				</header>
				<div class="panel-body">
					<table class="table table-no-more table-bordered table-striped mb-none">
						<thead>
							<tr>
								<th>Title</th>
								<th class="hidden-xs hidden-sm">Width</th>
