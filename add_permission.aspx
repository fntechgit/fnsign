<%@ Page Title="FNSIGN > Add Permission" Language="C#" MasterPageFile="~/fnsign.master" AutoEventWireup="true" CodeBehind="add_permission.aspx.cs" Inherits="fnsignManager.add_permission" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content_main" runat="server">
    <section role="main" class="content-body">
					<header class="page-header">
						<h2><%= add_edit.ToUpper() %> A PERMISSION FOR <%= user_name %></h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
                                ...
                                <li>
                                    <i class="fa fa-key"></i> <span><%= add_edit %> a Permission</span>
                                </li>
							</ol>
							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title"><%= add_edit %> a Permission</h2>
									</header>
									<div class="panel-body">
										<div class="form-horizontal form-bordered">
										    <div class="form-group">
												...
												<div class="col-md-6">
												    <asp:DropDownList runat="server" ID="ddl_event" data-plugin-multiselect />
												</div>
											</div>

                                            <div class="form-group">
												<label class="col-md-3 control-label">Security Level</label>
												<div class="col-md-6">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-9">
                                                    ...
                                                    <asp:HyperLink runat="server" ID="btn_permissions" CssClass="mb-xs mt-xs mr-xs btn btn-primary">View Permissions</asp:HyperLink>
												</div>
											</div>
